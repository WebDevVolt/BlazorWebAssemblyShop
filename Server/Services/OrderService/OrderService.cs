namespace GameShop.Server.Services.OrderService
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<ServiceResponse<bool>> PlaceOrder()
        {
            ...
            products?.ForEach(p => totalPrice += p.SalePrice * p.Quantity);
            ...
            _context.RemoveRange(_context.CartItems
